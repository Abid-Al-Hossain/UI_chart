# UI Foundry Chart Studio

Standalone visual Chart generator built with Next.js, React, and TypeScript.

Standalone Chart component studio for building native, preview-honest, React-exportable UI patterns that match the UI Foundry product line.
...
- designers building Chart UI quickly
- developers who need editable React starting points
- marketplace buyers who want a self-contained Chart generator
...
The editor is focused on controls that are native to Chart and useful in real product work:
- chart type intent, data items, labels, values, colors, legend, axes-like labels, and tooltip-like preview
- bar, line-like, donut-like, KPI, dashboard, and compact chart presentations
- surface, grid, radius, spacing, typography, and status color controls
- accessible summary text and data-label expectations
- React export for chart presentation shell

The goal is maximum useful depth without adding unrelated controls that would make the component stop reading as Chart.
...
This repo is intended to publish as Abid-Al-Hossain/UI_chart.
