...
export default function MetadataSection({ state, update }: Props) {
  return <SectionCard title="Metadata" subtitle="Chart-native accessibility metadata.">
...
<div className="rounded-2xl border p-4 text-sm" style={{ borderColor: "var(--border)", color: "var(--muted)" }}>Chart output is fixed to <strong role="presentation">role=&quot;img&quot;</strong> and links the visible chart to a generated description.</div></div>
    </SectionCard>;
}
